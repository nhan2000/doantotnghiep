<?php  
	...
	$select='id, ten'.$lang.' , tenkhongdauvi, tenkhongdauen, photo, ngaytao, mota'.$lang.' ';
	if($id!='')
	{
		/* Lấy bài viết detail */
		...
		$curPage = $get_page;
		$per_page = $optsetting['paging_news'];
		$startpoint = ($curPage * $per_page) - $per_page;
		$limit = " limit ".$startpoint.",".$per_page;
		$sql = "select $select from #_news where $where order by stt,id desc $limit";
