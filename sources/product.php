<?php  
	...
	$select_detail=' type, id, ten'.$lang.', tenkhongdauvi, tenkhongdauen, mota'.$lang.', noidung'.$lang.', masp, luotxem, id_brand, id_mau, id_size, id_list, id_cat, id_item, id_sub, id_tags, photo, options, giakm, giamoi, gia ,info_more,mod_huong,mod_gia,mod_dientich,ratting,review_count,ngaytao,ngaysua';
	...
	if (@$row_detail['review_count']>0) {
		$rating = round($row_detail['ratting'] / $row_detail['review_count']);
	}else{
		$rating = 5;
	}
