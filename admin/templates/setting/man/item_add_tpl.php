								...
								<div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
									...
									<?php if(isset($config['setting']['slogan']) && $config['setting']['slogan'] == true) { ?>
										<div class="form-group">
											...
											<input type="text" class="form-control" name="data[options][slogan<?=$k?>]" id="slogan<?=$k?>" placeholder="Slogan (<?=$k?>)" value="<?=$options['slogan'.$k]?>">
										</div>
									<?php } ?>
									<?php if(isset($config['setting']['diachi']) && $config['setting']['diachi'] == true) { ?>
										<div class="form-group">
											<label for="diachi">Địa chỉ:</label>
											<input type="text" class="form-control" name="data[options][diachi<?=$k?>]" id="diachi<?=$k?>" placeholder="Địa chỉ (<?=$k?>)" value="<?=$options['diachi'.$k]?>">
										</div>
									<?php } ?>
								</div>
							<?php } ?>
				...
				<div class="row">
					...
					<?php if(isset($config['setting']['messenger']) && $config['setting']['messenger'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control" name="data[options][messenger]" id="messenger" placeholder="messenger" value="<?=$options['messenger']?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if(isset($config['setting']['time_open']) && $config['setting']['time_open'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="time_open">Thời gian mở cửa:</label>
							<input type="text" class="form-control" name="data[options][time_open]" id="time_open" placeholder="Tọa độ google map" value="<?=$options['time_open']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['coppyright']) && $config['setting']['coppyright'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="coppyright">Coppyright:</label>
							<input type="text" class="form-control" name="data[options][coppyright]" id="coppyright" placeholder="Tọa độ google map" value="<?=$options['coppyright']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['paging_product']) && $config['setting']['paging_product'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="paging_product">Phân trang sản phẩm:</label>
							<input type="text" class="form-control" name="data[options][paging_product]" id="paging_product" placeholder="Tọa độ google map" value="<?=$options['paging_product']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['paging_news']) && $config['setting']['paging_news'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="paging_news">Phân trang tin tức:</label>
							<input type="text" class="form-control" name="data[options][paging_news]" id="paging_news" placeholder="Tọa độ google map" value="<?=$options['paging_news']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['paging_index']) && $config['setting']['paging_index'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="paging_index">Phân trang trang chủ:</label>
							<input type="text" class="form-control" name="data[options][paging_index]" id="paging_index" placeholder="Tọa độ google map" value="<?=$options['paging_index']?>">
						</div>
					<?php } ?>
				</div>
