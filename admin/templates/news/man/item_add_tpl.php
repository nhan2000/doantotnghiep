                ...
                <div class="row">
                    <?php if(isset($config['news'][$type]['dienthoai']) && $config['news'][$type]['dienthoai'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control" name="data[info_more][dienthoai]" id="dienthoai" placeholder="Điện thoại " value="<?=$info_more['dienthoai']?>">
                        </div>
                    <?php } ?>
                    <?php if(isset($config['news'][$type]['link_viber']) && $config['news'][$type]['link_viber'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="link_viber">Link viber:</label>
                            <input type="text" class="form-control" name="data[info_more][link_viber]" id="link_viber" placeholder="Link viber " value="<?=$info_more['link_viber']?>">
                        </div>
                    <?php } ?>
                    <?php if(isset($config['news'][$type]['link_zalo']) && $config['news'][$type]['link_zalo'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="link_zalo">Link zalo:</label>
                            <input type="text" class="form-control" name="data[info_more][link_zalo]" id="link_zalo" placeholder="Link zalo " value="<?=$info_more['link_zalo']?>">
                        </div>
                    <?php } ?>
                </div>
            </div>
